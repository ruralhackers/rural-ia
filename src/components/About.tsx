        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12 text-[#014a9b]">
            <motion.div
              ...
              className="border border-border p-8 hover:border-[#19ab9b] transition-colors group"
            >
              <h3 className="text-[#014a9b] text-sm font-bold uppercase tracking-wider mb-4 group-hover:text-[#19ab9b] transition-colors">
                De balde
              </h3>
